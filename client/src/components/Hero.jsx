...
const Hero = () => {
  ...
  return (
    <div className=" h-screen flex flex-col items-center justify-center gap-14 bg-light text-center">
        <h1 className=" font-semibold text-4xl md:text-5xl">Luxury cars on rent</h1>
        <form className=" flex flex-col md:flex-row items-start md:items-center justify-between p-6 rounded-lg md:rounded-full w-full max-w-80 md:max-w-200 bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)] ">
            ...
            <button className=" flex items-center justify-center px-9 py-3 gap-1 max-sm:mt-4 bg-primary hover:bg-primary-dull text-white rounded-full cursor-pointer">
